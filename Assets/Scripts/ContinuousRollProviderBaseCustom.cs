...
namespace UnityEngine.XR.Interaction.Toolkit
{
    ...
    public abstract class ContinuousRollProviderBaseCustom : LocomotionProvider
    {
        [SerializeField]
        ...
        protected void RollRig(float turnAmount)
        {
            ...
            if (CanBeginLocomotion() && BeginLocomotion())
            {
                ...
                if (xrOrigin != null)
                {
                    ...
                    xrOrigin.RotateAroundCameraPosition(xrOrigin.Camera.transform.forward, -turnAmount);
                }
